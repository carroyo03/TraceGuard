"""Protected Document-to-Email runner kept under the v0.1 public module path."""
...
def run_protected_agent(
    ...
    *,
    ...
    """Execute the protected bounded agent without evaluator-label access."""
    ...
    try:
        result = run_document_to_email_agent(scenario, "protected", provider=provider)
